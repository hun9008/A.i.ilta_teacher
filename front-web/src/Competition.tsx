...
const upcomingContests: Contest[] = [
  {
    ...
    endDate: '2024-08-30 21:00:00',
    status: '',
  },
  {
    grade: '2학년',
    name: '8월 5주차 수학 경진대회',
    startDate: '2024-08-30 20:00:00',
    endDate: '2024-08-30 21:00:00',
    status: '',
  },
  {
...
const pastContests: Contest[] = [
  {
    grade: '1학년',
    name: '8월 4주차 수학 경진대회',
    startDate: '2024-08-23 20:00:00',
    endDate: '2024-08-23 21:00:00',
    status: '종료',
  },
  {
    grade: '2학년',
...
const CompetitionPage: React.FC = () => {
  ...
  const getContestStatus = (contest: Contest) => {
    ...
    if (currentTime >= startTime && currentTime <= endTime) {
      ...
      return getTimeRemaining(contest.startDate);
    } else {
      return '종료';
    }
  };
  ...
  const canEnterContest = (contest: Contest, type: 'now' | 'last') => {
          ...
          <thead>
            <tr className="bg-tertiary-100">
              {[
                ...
                <th
                  key={header}
                  className="p-3 text-sm font-semibold text-gray-600 border border-gray-200"
                >
                  {header}
                </th>
              ))}
                ...
                <td className="p-3 text-center border border-gray-200">
                  <button
                    className={`py-2 px-4 rounded text-white ${
                      canEnterContest(contest, isUpcoming ? 'now' : 'last')
                    ...
                    onClick={() =>
                      handleEnterContest(contest, isUpcoming ? 'now' : 'last')
                    }
                  >
                    입장하기
                  </button>
